            ...
            <div>
                <div className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>3 A</h2>
                ...
                <div  className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>3 B</h2>
                        <table className={styles.table2}>
                ...
                <div className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>3 G</h2>
                        <table className={styles.table2}>
                ...
                <div className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>3 D</h2>
                        <table className={styles.table2}>
                ...
                <div className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>3 E</h2>
                        <table className={styles.table2}>
                ...
                <div className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>3 V</h2>
                        <table className={styles.table2}>
                ...
                <div className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>3 J</h2>
                        <table className={styles.table2}>
