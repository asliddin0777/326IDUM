            ...
            <div>
                <div data-aos="fade-up" className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>7 A</h2>
                ...
                <div data-aos="fade-up" className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>7 B</h2>
                        <table className={styles.table2}>
                ...
                <div data-aos="fade-up" className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>7 G</h2>
                        <table className={styles.table2}>
                ...
                <div data-aos="fade-up" className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>7 D</h2>
                        <table className={styles.table2}>
                ...
                <div data-aos="fade-up" className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>7 E</h2>
                        <table className={styles.table2}>
                ...
                <div data-aos="fade-up" className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>7 V</h2>
                        <table className={styles.table2}>
                ...
                <div data-aos="fade-up" className={styles.studentsPage}>
                    <div className={styles.containerStudent}>
                        <h2 style={{ marginTop: 20, marginBottom: 20 }}>7 J</h2>
                        <table className={styles.table2}>
